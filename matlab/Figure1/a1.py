...
Run
---
python plot_GDGX_spillover_map_v3.py
...
OUT_PNG = "south_china_spillover_map_v3.png"
OUT_PDF = "south_china_spillover_map_v3.pdf"
OUT_SVG = "south_china_spillover_map_v3.svg"
OUT_NOTE = "map_source_note_v3.txt"
...
def main():
    ...
    gx_label_x = gx_c.x - 0.045 * w
    gx_label_y = gx_c.y + 0.028 * h

    gd_label_x = gd_c.x + 0.085 * w
    gd_label_y = gd_c.y + 0.020 * h
    ...
    # Spillover arrows
    # --------------------------------------------------------
    arrow_cx = (gx_c.x + gd_c.x) / 2 + 0.012 * w
    arrow_cy = (gx_c.y + gd_c.y) / 2 - 0.070 * h
    ...
    # China inset
    # --------------------------------------------------------
    ax_in = fig.add_axes([0.805, 0.665, 0.16, 0.225])
